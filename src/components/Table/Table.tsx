    ...
    <div className="overflow-x-auto max-w-[340px] rounded-lg mx-auto md:max-w-full shadow-md sm:rounded-lg ">
      <table className="w-full text-sm text-left text-gray-500">
        <thead className=" text-xs text-gray-700 uppercase bg-gray-50">
          <tr>
            <th className="ps-6 py-3">Room Name</th>
            <th className="ps-6 py-3">Unit Price</th>
            <th className="ps-6 py-3">Price</th>
            <th className="ps-6 py-3">Discount</th>
            <th className="ps-6 py-3">No. Days Booked</th>
            <th className="ps-6 py-3">Days Left</th>
            <th className="ps-6 py-3"></th>
          </tr>
        </thead>
        <tbody>
